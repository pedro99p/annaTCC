...
protected:
  ...
  Serializer * memoryMultiKeyWrenSerializer;
  ...
  MemoryMultiKeyWrenKVS *wren_kvs;
    ...
    wren_kvs = new MemoryMultiKeyWrenKVS();
    memoryMultiKeyWrenSerializer = new MemoryMultiKeyWrenSerializer(wren_kvs);
    ...
    serializers[LatticeType::WREN] = memoryMultiKeyWrenSerializer;


    wt = ServerThread(ip, ip, thread_id);
    th = new TransactionalHelper(wt.id());
  ...
  virtual ~ServerHandlerTest() {
    ...
    delete serializers[LatticeType::WREN];
